(function () {
    AuditMainController.$inject = ['$scope', '$rootScope', '$state', '$filter', 'OPRiskService', 'ChartFactory', 'Utils'];
    app.controller('AuditMainCtrl', AuditMainController);

    function AuditMainController ($scope, $rootScope, $state, $filter, OPRiskService, ChartFactory, Utils){
        $scope.mainTitle = 'AUDIT MANAGEMENT';
