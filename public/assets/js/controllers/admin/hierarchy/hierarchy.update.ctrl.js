(function () {
    HierarchyUpdateCtrl.$inject = ['$scope', '$rootScope', '$state', '$uibModal', '$filter', 'HierarchyService', 'Utils'];
    app.controller('HierarchyUpdateCtrl', HierarchyUpdateCtrl);

    function HierarchyUpdateCtrl($scope, $rootScope, $state, $uibModal, $filter, HierarchyService, Utils) {
        var vm = this;
